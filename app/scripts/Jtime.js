    ...
    this.getDayPanel = function()
    {
        ...
        for(var i=0; i<= 5; i++){
            ...
            for(var j=0; j< 7; j++){
                ...
                cell.setAttribute('style', 'width:30px;height:30px;text-align:center;font-weight:bold;padding: 0px 8px;');
                cell.style.cssText = 'width:30px;height:30px;text-align:center;font-weight:bold;padding: 0px 8px;';
